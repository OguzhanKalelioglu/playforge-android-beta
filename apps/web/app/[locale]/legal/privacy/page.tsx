      ...
      <div className="prose prose-slate dark:prose-invert mt-8 space-y-6 text-sm">
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:kvkk@playforge.app" className="text-primary underline">kvkk@playforge.app</a>{' '}
        ...
        <section>
          ...
          <p>
            Veri sorumlusu iletişim: <a href="mailto:kvkk@playforge.app" className="text-primary underline">kvkk@playforge.app</a>
          </p>
        </section>
      </div>
    </div>
