      ...
      <div className="prose prose-slate dark:prose-invert mt-8 space-y-6 text-sm">
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-1">
            <li>
              <a href="mailto:refund@playforge.app" className="text-primary underline">refund@playforge.app</a>{' '}
        ...
        <section>
          ...
          <p>
            İade soruları: <a href="mailto:refund@playforge.app" className="text-primary underline">refund@playforge.app</a>
          </p>
        </section>
      </div>
    </div>
